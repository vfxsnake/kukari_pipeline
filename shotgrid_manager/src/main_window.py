...
class MainWindow(QMainWindow):
    ...
    def on_publish_requested(self, task_data):
        """
        Handle publish request when user drops task in 'In Review' column.
        ...
        if reply == QMessageBox.Yes:
            ...
            self.on_task_status_update(task_id, old_status, 'rev')
